...
const PaymentForm = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-gray-800 via-gray-700 to-gray-800 text-gray-300 sm:p-6 rounded-lg shadow-xl min-h-screen flex items-center justify-center">
